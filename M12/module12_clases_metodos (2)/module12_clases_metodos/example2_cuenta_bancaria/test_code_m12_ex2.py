...
try:
    # TODO: cambia 'solution_m12_ex2' por 'student_code_m12_ex2' si estás usando el código del estudiante.
    # from solution_m12_ex2 import CuentaBancaria
    from student_code_m12_ex2 import CuentaBancaria  # Descomenta
except ImportError:
    pytest.fail(
