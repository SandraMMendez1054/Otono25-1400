...
try:
    # TODO cambia 'solution_m12_ex1' por 'student_code_m12_ex1' si estás usando el código del estudiante.
    # from solution_m12_ex1 import Rectangulo
    from student_code_m12_ex1 import Rectangulo
except ImportError:
    pytest.fail(
