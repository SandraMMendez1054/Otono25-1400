...
`student_code_mX_exX.py`: Código base que debes completar.
`test_code_mX_exX.py`: Script para probar automáticamente tu código.

## 🧑‍💻 Instrucciones para los estudiantes
1. Abrir el proyecto en VS Code
- Descarga todos los archivos de ejercicios  Download archivos de ejerciciosy colócalos en una carpeta de tu repositorio (ex: `module_12/proyectos/`).
...
- Sube todas las carpetas con tus soluciones (example1_..., example2_..., example3_...).
