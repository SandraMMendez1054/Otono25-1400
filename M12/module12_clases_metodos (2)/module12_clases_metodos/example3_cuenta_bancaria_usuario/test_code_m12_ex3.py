...
try:
    # TODO: cambia 'solution_m12_ex3' por 'student_code_m12_ex3' si estás usando el código del estudiante.
    # from solution_m12_ex3 import Cliente, CuentaBancaria
    # Descomenta si estás usando el código del estudiante.
    from student_code_m12_ex3 import Cliente, CuentaBancaria
except ImportError:
    pytest.fail(
